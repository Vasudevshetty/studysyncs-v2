  ...
  return (
    <div className="text-white mt-8">
      ...
      {featuresData.map((feature, index) => (
        <div
          key={index}
          className={`flex flex-col md:flex-row justify-around items-center rounded-lg shadow-md mt-8 gap-6 md:gap-8 lg:gap-12 px-10 p-4 ${
        ...
        >
          ...
          {/* Text Section */}
          <div className={`flex flex-col justify-start gap-4 text-center md:text-left max-w-lg p-6  ${feature.textClass}`}>
            ...
            <Link
              ...
              className={`flex justify-center md:justify-start items-center gap-2 font-semibold text-sm md:text-base p-2 px-4 rounded-3xl transition-all duration-300 shadow-md w-40 ${
                feature.isComingSoon ? "bg-primary-yellow text-gray-700/90 hover:bg-yellow-600 rounded-xl" : "bg-primary-blue text-white hover:bg-blue-600"
              }`}
            >
